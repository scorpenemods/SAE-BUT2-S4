...
if (isset($_POST['company_id']) && isset($_POST['title']) && isset($_POST['address']) && isset($_POST['job']) && isset($_POST['description']) && isset($_POST['duration']) && isset($_POST['salary']) && isset($_POST['education']) && isset($_POST['start_date']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['latitude']) && isset($_POST['longitude'])) {
    ...
    $startDate = filter_input(INPUT_POST, 'start_date', FILTER_SANITIZE_STRING) ?? false;
