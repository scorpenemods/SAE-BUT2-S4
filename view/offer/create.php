...
<main class="container-principal">
    ...
    <form action="../../presenter/apply-offer.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="tags-container">
                ...
                <div id="tagsDropdown" class="tags-dropdown-content">
                    ...
                    foreach ($tags as $tag) {
                        echo "<label><input type='checkbox' name='tags' value='" . $tag . "'> " . $tag . "</label>";
                    }
                    ?>
                    <label><input type="checkbox" name="tags" value="developpement"> Développement</label>
                    ...
                    <label><input type="checkbox" name="tags" value="communication"> Communication</label>
                    <label><input type="checkbox" name="tags" value="finance"> Finance</label>
                    <label><input type="checkbox" name="tags" value="ressources-humaines"> Ressources Humaines</label>
                </div>
            </div>
        ...
        <button type="submit" onclick="applyOffer()">Publier l'offre</button>
    </form>
</main>
        ...
        checkboxes.forEach(checkbox => {
            if (checkbox.checked) {
                ...
                tag.innerHTML = `
                        ...
                        <button type="button" onclick="removeTag(this, '${checkbox.value}')">&times;</button>
                    `;
                selectedTagsContainer.appendChild(tag);
            }
        });

        updateDropdownButtonText(selectedCategories);
    }

    function removeTag(button, value) {
        const checkbox = document.querySelector(`input[name="tags"][value="${value}"]`);
