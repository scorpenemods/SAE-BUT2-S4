...
";
    ...
    ";
            ...
            $stmt = $this->connection->prepare($sql);
            $stmt->bindValue(':meeting_id', $meetingId, PDO::PARAM_INT);
            $stmt->bindValue(':tutor_comment', $tutorComment, PDO::PARAM_STR);
    ...
    public function getMeetingComments(int $meetingId): ?array
    {
        try {
            $sql = "SELECT tutor_comment, mentor_comment FROM MeetingComments WHERE meeting_id = :meeting_id";
            $stmt = $this->connection->prepare($sql);
            $stmt->bindValue(':meeting_id', $meetingId, PDO::PARAM_INT);
            $stmt->execute();
            ...
            echo "Database error (getMeetingComments): " . $e->getMessage();
            return null;
        }
    }
